...
public class HouseRobberII {
    ...
    public static int rob(int[] nums) {
        ...
        int lootSkippingLastHouse = robHelper(skipLastHouse);
        int lootSkippingFirstHouse = robHelper(skipFirstHouse);

        return Math.max(lootSkippingFirstHouse, lootSkippingLastHouse);
    }
