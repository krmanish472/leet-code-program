...
public class GasStation {
    public static void main(String[] args) {
        ...
        int startIdx = canCompleteCircuit(gas, cost);
    ...
    public static int canCompleteCircuit(int[] gas, int[] cost) {
        ...
        // journey is not possible if cost is more than available gas
        ...
        for (int i = 0; i < gas.length; i++) {
            ...
            if (currGas < 0) {
                startIdx = i + 1; // possible start index
                currGas = 0; // reset current gas to 0 - as we start fresh
            }
        }
        return startIdx;
    }
